...
#define MarkList '.'      /* Nilai tak terdefinisi */
#define InvalidIdxList -1 /* Indeks tak terdefinisi */

/* Definisi elemen dan koleksi objek */
#define IdxTypeList int
#define ElTypeList char
...
/* *** Selektor INDEKS *** */
IdxTypeList FirstIdxList(List L);
/* Prekondisi : list L tidak kosong */
/* Mengirimkan indeks elemen pertama */

IdxTypeList LastIdxList(List L);
/* Prekondisi : list L tidak kosong */
